...
function scode_support_html() {
	...
	<div class="wrap instruction">
		...
		<?php if (get_locale() == 'ru_RU') { ?>
			...
			<p>Если плагин вам действительно помог в работе и у вас есть желание меня отблагодарить в денежном выражении, то это можно сделать Webmoney R109400923968 или Z888279575784, либо на ЯД 41001651742138
			...
			<div class="autor_plugin">
				...
				<div>
					<img src="https://www.gravatar.com/avatar/afcaa467847bce7547124f48e0b46115?d=mm&s=50&r=G" alt="Vitalik" /><a href="http://wpskills.ru/" target="_blank">Николай Бирулин</a><br/>Разработка<br/>PHP & WP Developer
				</div>
			</div>
